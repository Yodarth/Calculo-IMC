                    ...
                    <?php
                        if($_POST){
                            ...
                            if($imc < 18.5){
                                ...
                                echo "<div align='center'><br><img src='img/imc-bajo' align='center' width=100 height=300 alt='foto'></div>";
                                echo "<br><h5 class= 'text-center' style='color: #A4BEDC'>IMC Bajo</h5>";
                            }
                            else if($imc >= 18.5 and $imc < 25){
                                echo "<input type='text' class= 'form-control col-6 mx-auto' style='color: #215732' value=".number_format($imc,1). ">";
                                echo "<div align='center'><br><img src='img/imc-normal' align='center' width=110 height=300 alt='foto'></div>";
                                echo "<br><h5 class= 'text-center' style='color: #98C1A1'>IMC Normal</h5> ";
                            }
                            else if($imc >= 25 and $imc < 30){
                                echo "<input type='text' class= 'form-control col-6 mx-auto' style='color: #215732' value=".number_format($imc,1). ">";
                                echo "<div align='center'><br><img src='img/imc-sobrepeso' align='center' width=120 height=300 alt='foto'></div>";
                                echo "<br><h5 class= 'text-center' style='color: #F7B104'>IMC Sobrepeso</h5> ";
                            }
                            else if($imc >= 30 and $imc < 35){
                                echo "<input type='text' class= 'form-control col-6 mx-auto' style='color: #215732' value=".number_format($imc,1). ">";
                                echo "<div align='center'><br><img src='img/imc-obesidad' align='center' width=130 height=300 alt='foto'></div>";
                                echo "<br><h5 class= 'text-center' style='color: #E0A556'>IMC Obesidad grado l</h5> ";
                            }
                            else if($imc >= 35 and $imc < 40){
                                echo "<input type='text' class= 'form-control col-6 mx-auto' style='color: #215732' value=".number_format($imc,1). ">";
                                echo "<div align='center'><br><img src='img/imc-morbido' align='center' width=160 height=300 alt='foto'></div>";
