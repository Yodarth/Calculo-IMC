    ...
    <body>
        ...
        <section id="seccion-calculo">
            ...
            <section id="morecolor" style="color: #DEE6E2">
                <br><p>Información recuperada de: <br>Bienestar Nutrimental. (s. f.). Nutrioli. Recuperado 9 <br>de octubre de 2022, de https://www.nutrioli.com/bienestar-nutrimental/<br><br>VIVIR SALUDABLE PARA MANTENER LA MENTE Y EL CUERPO SANO. (s. f.). <br>Residential Plaza Blue Lagoon. Recuperado 9 de octubre de 2022, de <br>https://residentialplaza.com/vivir-saludable-para-mantener-la-mente-y-el-cuerpo<br>-sano/</p>
            </section>
